...
d3.csv('data/beer.csv', function(data) {

  var xAxis = 'rent', yAxis = 'beer';
  var xAxisOptions = ["rent", "salary", "wage", "minutes"]
  // var yAxisOptions = ["beer"];
  var descriptions = {
    "rent" : "Median 2-bedroom apartment rent",
    "salary" : "Average salary per person",
    "wage": "Average hourly wage",
    "minutes" : "How many minutes one has to work to buy a 6-pack Heineken beer"
  };
  ...
  d3.select('svg g.chart')
    ...
    .on('mouseover', function(d) {
      d3.select('svg g.chart #cityLabel')
        .text(d.city)
        .transition()
        .style('opacity', 1);
    })
